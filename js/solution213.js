...
// (defaults to "John" if not set), lastName/LastName (defaults to "Doe" 
// if not set), age/Age (defaults to 0 if not set) and gender/Gender 
// (defaults to "Male" if not set). These should be stored in 
